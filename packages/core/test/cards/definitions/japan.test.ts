...
describe('Japan Card Definitions', () => {
  // ─── Total count: 3 emperors + 9 ministers + 6 generals + 18 minions + 4 stratagems + 6 sorceries = 46 ───

  it('should have exactly 46 entities (37 Card + 9 Minister)', () => {
  ...
  it('JAPAN_ALL_CARDS should contain all 37 Card objects', () => {
    expect(JAPAN_ALL_CARDS).toHaveLength(37);
  });
  ...
  describe('Card type counts', () => {
    ...
    it('should have 18 minions', () => { expect(JAPAN_MINIONS).toHaveLength(18); });
