...
describe('Germany Card Definitions', () => {
  ...
  it('GERMANY_ALL_CARDS should contain all 27 Card objects', () => {
    expect(GERMANY_ALL_CARDS).toHaveLength(27);
  });
  ...
  describe('Card type counts', () => {
    ...
    it('should have 8 minions', () => { expect(GERMANY_MINIONS).toHaveLength(8); });
